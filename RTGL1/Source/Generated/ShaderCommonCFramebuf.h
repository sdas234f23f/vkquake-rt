...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_Q2_COLOR_L_F_S_H = 82,
    FB_IMAGE_INDEX_Q2_COLOR_L_F_S_H_PREV = 83,
    FB_IMAGE_INDEX_Q2_COLOR_L_F_C_O_C_G = 84,
    FB_IMAGE_INDEX_Q2_COLOR_L_F_C_O_C_G_PREV = 85,
    FB_IMAGE_INDEX_Q2_COLOR_H_F = 86,
    FB_IMAGE_INDEX_Q2_COLOR_H_F_PREV = 87,
    FB_IMAGE_INDEX_Q2_COLOR_SPEC = 88,
    FB_IMAGE_INDEX_Q2_COLOR_SPEC_PREV = 89,
    FB_IMAGE_INDEX_Q2_VIEW_DEPTH = 90,
    FB_IMAGE_INDEX_Q2_VIEW_DEPTH_PREV = 91,
    FB_IMAGE_INDEX_Q2_BASE_COLOR = 92,
    FB_IMAGE_INDEX_Q2_BASE_COLOR_PREV = 93,
    FB_IMAGE_INDEX_Q2_METALLIC = 94,
    FB_IMAGE_INDEX_Q2_METALLIC_PREV = 95,
    FB_IMAGE_INDEX_Q2_BOUNCE_THROUGHPUT = 96,
    FB_IMAGE_INDEX_Q2_TRANSPARENT = 97,
    FB_IMAGE_INDEX_Q2_GOD_RAYS_THROUGHPUT_DIST = 98,
    FB_IMAGE_INDEX_Q2_FOG_ACCUM = 99,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_S_H = 100,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_S_H_PREV = 101,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_C_O_C_G = 102,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_C_O_C_G_PREV = 103,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_H_F = 104,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_H_F_PREV = 105,
    FB_IMAGE_INDEX_Q2_HIST_MOMENTS_H_F = 106,
    FB_IMAGE_INDEX_Q2_HIST_MOMENTS_H_F_PREV = 107,
    FB_IMAGE_INDEX_Q2_FILTERED_SPEC = 108,
    FB_IMAGE_INDEX_Q2_FILTERED_SPEC_PREV = 109,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_L_F_S_H = 110,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_L_F_S_H = 111,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_L_F_C_O_C_G = 112,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_L_F_C_O_C_G = 113,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_H_F = 114,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_H_F = 115,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_SPEC = 116,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_SPEC = 117,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_MOMENTS = 118,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_MOMENTS = 119,
    FB_IMAGE_INDEX_Q2_GRAD_L_F_PING = 120,
    FB_IMAGE_INDEX_Q2_GRAD_L_F_PONG = 121,
    FB_IMAGE_INDEX_Q2_GRAD_H_F_SPEC_PING = 122,
    FB_IMAGE_INDEX_Q2_GRAD_H_F_SPEC_PONG = 123,
    FB_IMAGE_INDEX_Q2_GRAD_SMPL_POS = 124,
    FB_IMAGE_INDEX_Q2_GRAD_SMPL_POS_PREV = 125,
    FB_IMAGE_INDEX_Q2_COLOR = 126,
    FB_IMAGE_INDEX_Q2_TAA_OUTPUT = 127,
    FB_IMAGE_INDEX_Q2_TAA_HISTORY = 128,
    FB_IMAGE_INDEX_Q2_TAA_HISTORY_PREV = 129,
    FB_IMAGE_INDEX_Q2_RNG_SEED = 130,
    FB_IMAGE_INDEX_Q2_RNG_SEED_PREV = 131,
};
